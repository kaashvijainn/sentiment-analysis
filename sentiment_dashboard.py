...
# Configure page
st.set_page_config(
    page_title="Bankruptcy Risk Sentiment Analyzer",
    layout="wide",
...
def main():
    ...
    if 'analysis_result' in st.session_state:
        ...
        ###  **Core Features**
        - **FinBERT Sentiment Analysis**: Specialized financial language understanding
        - **Bankruptcy Risk Detection**: 200+ critical financial distress indicators
        - **Complexity Scoring**: Detection of linguistic manipulation and obfuscation
        - **Readability Analysis**: Fog Index, Flesch-Kincaid, and complexity metrics
        - **Visual Analytics**: Interactive charts and real-time analysis
       
        ### **How to Use**
        1. **Select a Company** from the dropdown in the sidebar
        2. **Click "Analyze Company"** to start the analysis
        3. **Review Results**: Examine sentiment, risk indicators, and complexity scores
       
        ### **What You'll Get**
        - **Sentiment Classification** (Positive/Negative/Neutral)
        - **Bankruptcy Risk Assessment** (High/Medium/Low Risk)
        - **Language Complexity Analysis** (Detecting potential manipulation)
        - **Interactive Visualizations** (Sentiment flow, risk distribution, readability)
        - **Detailed Sentence Analysis** (Risk terms, valence shifters, metrics)
       
        ---
        """)
       
        # Instructions
        st.info("**Get started by selecting a company from the sidebar to analyze its financial data.**")
        ...
        with st.container():
            ...
            with feature_col1:
                ...
                **Domain Expertise**
                ...
                - Bankruptcy-specific lexicon
                - Regulatory compliance focus
                """)
            with feature_col2:
                st.markdown("""
                **Advanced Analytics**
                - Valence shifter detection
                - Complexity manipulation scoring
